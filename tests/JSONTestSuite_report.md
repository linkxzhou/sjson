...
| n_array_newlines_unclosed.json | ✗ | 无法识别的JSON token类型: 1 | ✗ | unexpected end of JSON input | ✓ |
| n_array_number_and_comma.json | ✗ | 无法识别的JSON token类型: 13 | ✗ | invalid character ']' looking for beginning of value | ✓ |
...
| n_number_0_capital_E+.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character ']' in exponent of numeric literal | ✓ |
| n_number_0_capital_E.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character ']' in exponent of numeric literal | ✓ |
| n_number_0e+.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character ']' in exponent of numeric literal | ✓ |
| n_number_0e.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character ']' in exponent of numeric literal | ✓ |
...
| n_number_2.e-3.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'e' after decimal point in numeric literal | ✓ |
| n_number_2.e3.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'e' after decimal point in numeric literal | ✓ |
| n_number_9.e+.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'e' after decimal point in numeric literal | ✓ |
...
| n_string_1_surrogate_then_escape_u1.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character '"' in \u hexadecimal character escape | ✓ |
| n_string_1_surrogate_then_escape_u1x.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'x' in \u hexadecimal character escape | ✓ |
| n_string_accentuated_char_no_quotes.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'Ã' looking for beginning of value | ✓ |
| n_string_backslash_00.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character '\x00' in string escape code | ✓ |
| n_string_escape_x.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'x' in string escape code | ✓ |
| n_string_escaped_backslash_bad.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | unexpected end of JSON input | ✓ |
| n_string_escaped_ctrl_char_tab.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character '\t' in string escape code | ✓ |
| n_string_escaped_emoji.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'ð' in string escape code | ✓ |
| n_string_incomplete_escape.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | unexpected end of JSON input | ✓ |
| n_string_incomplete_escaped_character.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character '"' in \u hexadecimal character escape | ✓ |
| n_string_incomplete_surrogate.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character '"' in \u hexadecimal character escape | ✓ |
| n_string_incomplete_surrogate_escape_invalid.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'x' in string escape code | ✓ |
| n_string_invalid-utf-8-in-escape.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'å' in \u hexadecimal character escape | ✓ |
| n_string_invalid_backslash_esc.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'a' in string escape code | ✓ |
| n_string_invalid_unicode_escape.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'q' in \u hexadecimal character escape | ✓ |
| n_string_invalid_utf8_after_escape.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'å' in string escape code | ✓ |
| n_string_leading_uescaped_thinspace.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character '\\' looking for beginning of value | ✓ |
| n_string_no_quotes_with_bad_escape.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character '\\' looking for beginning of value | ✓ |
| n_string_single_doublequote.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | unexpected end of JSON input | ✓ |
| n_string_single_quote.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character '\'' looking for beginning of value | ✓ |
| n_string_single_string_no_double_quotes.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'a' looking for beginning of value | ✓ |
| n_string_start_escape_unclosed.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character ' ' in string escape code | ✓ |
| n_string_unescaped_ctrl_char.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character '\x00' in string literal | ✓ |
...
| i_number_huge_exp.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | json: cannot unmarshal number 0.4e00669999999999999999999999... | ✓ |
| i_number_neg_int_huge_exp.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | json: cannot unmarshal number -1e+9999 into Go value of type... | ✓ |
| i_number_pos_double_huge_exp.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | json: cannot unmarshal number 1.5e+9999 into Go value of typ... | ✓ |
| i_number_real_neg_overflow.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | json: cannot unmarshal number -123123e100000 into Go value o... | ✓ |
| i_number_real_pos_overflow.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | json: cannot unmarshal number 123123e100000 into Go value of... | ✓ |
...
| i_string_UTF-16LE_with_BOM.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character 'ÿ' looking for beginning of value | ✓ |
...
| i_string_utf16BE_no_BOM.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character '\x00' looking for beginning of value | ✓ |
| i_string_utf16LE_no_BOM.json | ✗ | 无法识别的JSON token类型: 0 | ✗ | invalid character '\x00' looking for beginning of value | ✓ |
